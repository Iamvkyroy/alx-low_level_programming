...
/**
 * shash_table_create - It creates the sorted hash table.
...
/**
 * shash_table_set - It adds an element to the sorted hash table.
 * @ht: The pointer to the sorted hash table.
 * @key: The key to add - cant be an empty string.
...
/**
 * shash_table_print - It prints the sorted hash table in order.
 * @ht: The pointer to the sorted hash table.
 */
void shash_table_print(const shash_table_t *ht)
{
